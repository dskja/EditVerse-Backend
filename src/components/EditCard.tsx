  ...
  return (
    <>
      <div
        ...
        className="group relative flex flex-col overflow-hidden rounded-xl bg-zinc-900 border border-zinc-800 transition-all hover:border-zinc-700 cursor-pointer"
      >
        <div className="relative aspect-video w-full overflow-hidden bg-black">
          <Image
            src={edit.thumbnailUrl || "https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=800&auto=format&fit=crop"}
            alt={edit.title}
            fill
        ...
        <div className="p-4">
          ...
          <div className="mt-4 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-zinc-300 truncate">{edit.editorName || "Unknown User"}</span>
            </div>
      ...
      {isModalOpen && (
        <VideoModal edit={edit} onClose={() => setIsModalOpen(false)} />
      )}
    </>
  );
}